...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "sqldelight-pgvectorscale"
            groupId = project.group.toString()
            version = project.version.toString()

            pom {
                name.set("SQLDelight PgVectorScale Module")
                description.set("SQLDelight module for PgVectorScale support")
                url.set("https://github.com/griffio/sqldelight-pgvectorscale-module-app")
                ...
                scm {
                    connection.set("scm:git:git://github.com/griffio/sqldelight-pgvectorscale-module-app.git")
                    developerConnection.set("scm:git:ssh://github.com/griffio/sqldelight-pgvectorscale-module-app.git")
                    url.set("https://github.com/griffio/sqldelight-pgvectorscale-module-app")
                }
            }
        }
...
jreleaser {
    gitRootSearch = true
    project {
        description = "SQLDelight module for PgVectorScale support"
